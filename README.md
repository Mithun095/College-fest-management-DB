This project is a full-stack web application designed to efficiently manage and track events for a college fest. Built using Node.js, Express, MySQL, and a simple HTML/CSS/JS frontend, it allows:
